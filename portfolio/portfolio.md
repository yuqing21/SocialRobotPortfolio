...
- [Social Robot Design Portfolio](#social-robot-design-portfolio)
- [About Me](#about-me)
- [Group Work](#group-work)
  - [Case Description](#case-description)
    - [Existed Functions and Scenario Analysis](#existed-functions-and-scenario-analysis)
      - [Stories/narratives in media and project data & Currently developed scenarios](#storiesnarratives-in-media-and-project-data--currently-developed-scenarios)
    - [Our case](#our-case)
- [Selection of Useful Design Tools](#selection-of-useful-design-tools)
  - [Senario Analysis](#senario-analysis)
  - [Story Boarding](#story-boarding)
  - [Wizard of Oz](#wizard-of-oz)
  - [Lego Series](#lego-series)
- [Senarios](#senarios)
  - [Low user trust/low robot understanding](#low-user-trustlow-robot-understanding)
  - [High user trust/low robot understanding](#high-user-trustlow-robot-understanding)
  - [Low user trust/high robot understanding](#low-user-trusthigh-robot-understanding)
- [Expressiveness](#expressiveness)
  - [A tool* for expressiveness](#a-tool-for-expressiveness)
    - [Expressive Cue Cards](#expressive-cue-cards)
    - [Hardware modules/low-fidelity prototypes](#hardware-moduleslow-fidelity-prototypes)
    - [Improvisational Scenarios](#improvisational-scenarios)
- [Design Behavior](#design-behavior)
  - [Scenario 1: Helping Reach High or Low Items](#scenario-1-helping-reach-high-or-low-items)
  - [Scenario 2: Keeping the Environment Clean](#scenario-2-keeping-the-environment-clean)
  - [Scenario 3: Measuring Blood Pressure](#scenario-3-measuring-blood-pressure)
  - [Scenario 4: Urine Test Analysis](#scenario-4-urine-test-analysis)
  - [Scenario 5: Logging and Reporting Results](#scenario-5-logging-and-reporting-results)
...
- [Reflections](#reflections)
  ...
  - [Sci-fi prototyping](#sci-fi-prototyping)
  - [21st century robot project](#21st-century-robot-project)
  - [Rosy consumer stories](#rosy-consumer-stories)
  - [Importance of storytelling for HRI specifically](#importance-of-storytelling-for-hri-specifically)
  - [Evidence based work (health) vs robot stories (and perceived competence)](#evidence-based-work-health-vs-robot-stories-and-perceived-competence)
  - [Design (rules) from the work of Ju&Hoffman](#design-rules-from-the-work-of-juhoffman)
  - [Laban works for characterising motion. Which aspects apply to sound or other modalities?](#laban-works-for-characterising-motion-which-aspects-apply-to-sound-or-other-modalities)
  - [Can you design anti-social behaviour? What is the difference with simply the 'absence' of social behaviour?](#can-you-design-anti-social-behaviour-what-is-the-difference-with-simply-the-absence-of-social-behaviour)
  - [Embodied agents vs virtual agents and hybrid shapes](#embodied-agents-vs-virtual-agents-and-hybrid-shapes)
  - [Robotic capabilities vs social aspects of the design](#robotic-capabilities-vs-social-aspects-of-the-design)
  - ['Function defines form' vs social requirements?](#function-defines-form-vs-social-requirements)
  - [What are relevant insights by Duffy et al. for you as a designer](#what-are-relevant-insights-by-duffy-et-al-for-you-as-a-designer)
